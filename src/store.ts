...
function migrateTrade(raw: Partial<Trade>): Trade {
  ...
  const base: Trade = {
    ...
    protraction: '', lqSweep: '', asiaHlSweep: '', euM5Shift: '', euM15Shift: '', dxyM5Shift: '', dxyM15Shift: '', divergence: '', divergencePosNeg: '', highLow: '',
    dseDirection: '', dseStage: '',
    tradeNotes: '', emotions: '', newsEvent: '',
  ...
  return {
    ...
    asiaHlSweep: migrateStr(legacy.asiaHlSweep),
    euM5Shift: migrateStr(legacy.euM5Shift),
    euM15Shift: migrateStr(legacy.euM15Shift),
    dxyM5Shift: migrateStr(legacy.dxyM5Shift),
    dxyM15Shift: migrateStr(legacy.dxyM15Shift),
    dseDirection: (raw.dseDirection as string) || '',
    dseStage: (raw.dseStage as string) || '',
    newsEvent: (raw.newsEvent as string) || '',
